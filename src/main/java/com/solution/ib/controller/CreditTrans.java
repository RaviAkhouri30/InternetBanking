...
/**
 * Servlet implementation class CreditTrans
 */
@WebServlet("/CreditTrans")
public class CreditTrans extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		Logger LOGGER = Logger.getLogger(CreditTrans.class.getName());
		try {
		...
		dat = dao.getCreditTransaction(det.getAcc_No());
